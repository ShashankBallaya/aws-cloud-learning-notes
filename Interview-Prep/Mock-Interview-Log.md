...
AWS secures the cloud - things like physical data centers, hardware, networking, and the hypervisor.
...
In my projects, I handled IAM roles, security groups, and S3 bucker policies - that's my side of the model.
...
- "R-series > memory-heavy (databaes, caching)"
...
S3 has multiple storage classse based on cost and access:
- Standard - frequent access
- Standard-IA - Infrequent access
- One Zone-IA - cheaper, single AZ
- Glacier - archival
- Intelligent-Tiering - auto optimization
I also used lifecyle rules to move data to cheaper tiers 
...
- Configured IGW, NAT, route tables
